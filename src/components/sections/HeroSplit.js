            ...
            <div className={splitClasses}>
              <div className="split-item" style={inlineStyle()}>
                <div className="hero-content split-item-content center-content-mobile">
                  ...
                  >
                    Pensi che solo i medici possano aiutare?
                  </h1>
                  <p
                    className="mt-0 mb-32 reveal-from-bottom"
                    data-reveal-delay="300"
                  >
                    Hack@Home è un hackthon di due giorni dove costruire
                    prodotti utili durante l'emergenza COVID. Da casa tua.
                  </p>
                  <div className="reveal-from-bottom" data-reveal-delay="450">
                    <Button
                      tag="a"
                      color="primary"
                      href="https://antoniomarsella95.typeform.com/to/VkEqn0"
                      wideMobile
                    >
